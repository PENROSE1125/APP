...
namespace BarcodeInspection.Controls
{
    /// <summary> 
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        internal void AddRange(List<LOBSM010View> listSearchResult, NotifyCollectionChangedAction reset)
        {
            throw new NotImplementedException();
        }

        internal void AddRange(List<LOBSM020View> listSearchResult, NotifyCollectionChangedAction reset)
        {
            throw new NotImplementedException();
        }
