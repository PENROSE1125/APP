...
namespace BarcodeInspection
{
    public partial class App : Application
    {
        public App()
        {
            ...
            //      MainPage = new MainPage(new Views.Outbound.LOBSM010View());
            //  MainPage = new Views.Outbound.LOBSM010View(new Views.Outbound.LOBSM010View());
            MainPage = new NavigationPage(new Views.Outbound.LOBSM010View());
        }
